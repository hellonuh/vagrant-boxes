...
yes | cp /vagrant/svn/conf/svnserve.conf /srv/svn/conf
yes | cp /vagrant/svn/conf/passwd /srv/svn/conf
...
cp /vagrant/svn/scripts/svnserve /etc/default
cp /vagrant/svn/scripts/svnserve.service /etc/systemd/system
